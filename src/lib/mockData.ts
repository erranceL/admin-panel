...
export const mockAuditLogs: AuditLogItem[] = [
  ...
  },
  {
    id: 'audit_004',
    actor: 'Admin',
    action: 'finalize_market',
    target: 'rfq:match:1001103:total25',
    result: 'success',
    before_value: 'disputed',
    after_value: 'finalized',
    reason: '人工复核比分后最终确认',
    created_at: '2026-05-28T13:20:44Z',
  },
  {
    id: 'audit_005',
    actor: 'Admin',
    ...
    target: 'Ops',
    result: 'success',
    reason: '收回运营对外部参考价的访问',
    created_at: '2026-05-28T14:02:10Z',
  },
]
...
export const mockRebateRecords: RebateRecord[] = [
  {
    ...
    username: '用户 10001',
    coin: 'USDT',
    trade_id: 'trade_88f201',
    market_title: '曼城 vs 阿森纳 · 全场胜平负',
    trade_volume: '1200.00',
    rebate_amount: '6.00',
    rate_bps: 50,
    status: 'settled',
    created_at: '2026-05-28T12:41:00Z',
  },
  {
    id: 'rb_10001_02',
    account_id: 10001,
    username: '用户 10001',
    coin: 'USDT',
    trade_id: 'trade_88f255',
    market_title: '曼城 vs 阿森纳 · 全场大小球 2.5',
    trade_volume: '800.00',
    rebate_amount: '4.00',
    rate_bps: 50,
    status: 'pending',
    created_at: '2026-05-28T12:58:00Z',
  },
  {
    id: 'rb_10002_01',
    account_id: 10002,
    username: '用户 10002',
    coin: 'USDT',
    trade_id: 'trade_91a004',
    market_title: '皇家马德里 vs 巴塞罗那 · 全场胜平负',
    trade_volume: '3500.00',
    rebate_amount: '17.50',
    rate_bps: 50,
    status: 'settled',
  ...
  },
  {
    ...
    username: '用户 10002',
    coin: 'USDT',
    trade_id: 'trade_91a060',
    market_title: '英超冠军',
    trade_volume: '500.00',
    rebate_amount: '2.50',
    rate_bps: 50,
    status: 'reversed',
    created_at: '2026-05-27T18:05:00Z',
  },
  {
    id: 'rb_10003_01',
    account_id: 10003,
    username: '用户 10003',
    coin: 'USDT',
    trade_id: 'trade_77c310',
    market_title: '拜仁慕尼黑 vs 多特蒙德 · 全场大小球 2.5',
    trade_volume: '2200.00',
    rebate_amount: '11.00',
    rate_bps: 50,
    status: 'settled',
    created_at: '2026-05-28T11:48:00Z',
  },
  {
    id: 'rb_10003_02',
    account_id: 10003,
    username: '用户 10003',
    coin: 'USDT',
    trade_id: 'trade_77c398',
    market_title: '拜仁慕尼黑 vs 多特蒙德 · 全场胜平负',
    trade_volume: '640.00',
    rebate_amount: '3.20',
    rate_bps: 50,
    status: 'pending',
...
export const mockEventStats: EventStats[] = [
  {
    event_id: 'evt_epl_2026',
    event_name: '英超 2025/26',
    league: '英超',
    matches: 2,
    markets: 14,
    gmv_usd: '684231.20',
    ...
    match_stats: [
      ...
      },
      {
        ...
        market_stats: [
          {
            market_id: 'rfq:match:1001104:1x2',
            market_title: '全场胜平负',
            status: 'open',
            gmv_usd: '258900.00',
            volume_24h_usd: '141200.00',
            quotes: 3990,
            trades: 1720,
            fill_rate: 0.41,
            reject_rate: 0.07,
          ...
          {
            market_id: 'rfq:match:1001104:ah',
            market_title: '亚洲让球 -0.5',
            status: 'open',
            gmv_usd: '141010.10',
            volume_24h_usd: '70210.00',
            quotes: 2110,
            trades: 981,
            fill_rate: 0.36,
            reject_rate: 0.09,
  ...
  {
    event_id: 'evt_laliga_2026',
    event_name: '西甲 2025/26',
    league: '西甲',
    matches: 1,
    markets: 6,
    gmv_usd: '391008.56',
    ...
    match_stats: [
      {
        ...
        market_stats: [
          {
            market_id: 'rfq:match:1001102:1x2',
            market_title: '全场胜平负',
            status: 'open',
            gmv_usd: '251008.56',
            volume_24h_usd: '160000.00',
            quotes: 4980,
            trades: 2210,
            fill_rate: 0.40,
            reject_rate: 0.08,
          ...
          {
            market_id: 'rfq:match:1001102:total25',
            market_title: '全场大小球 2.5',
            status: 'open',
            gmv_usd: '140000.00',
            volume_24h_usd: '83000.00',
            quotes: 2600,
            trades: 1192,
            fill_rate: 0.35,
            reject_rate: 0.11,
...
export const mockRolePermissions: RolePermission[] = [
  { role: 'Admin', modules: ['/dashboard', '/rfq', '/polymarket', '/distributors', '/ops', '/rebate', '/stats', '/kpi', '/audit'] },
  { role: 'CS', modules: ['/dashboard', '/rebate'] },
  { role: 'Ops', modules: ['/dashboard', '/rfq', '/polymarket', '/distributors', '/ops', '/rebate', '/stats', '/kpi'] },
  { role: 'Risk', modules: ['/dashboard', '/rfq', '/distributors', '/stats', '/kpi', '/audit'] },
  { role: 'SRE', modules: ['/dashboard', '/polymarket', '/ops', '/audit'] },
]
